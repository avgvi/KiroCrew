...
#: Fields ``work_ledger_record`` forwards. The action selects which of them the
#: route requires; sending one an action does not use is the store's
#: ``invalid_value``, not a silent no-op.
