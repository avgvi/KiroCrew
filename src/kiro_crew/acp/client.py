...
CREDENTIAL_POINTER_ENV_VARS: frozenset[str] = frozenset(
    {
        ...
        # plus the file holding the bearer that authorizes that GET. Not a
        # filesystem path, so no mask or HOME remap can reach it -- which is
        # exactly why it has to be dropped from the env rather than fenced.
