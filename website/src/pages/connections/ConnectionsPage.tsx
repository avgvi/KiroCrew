        ...
        for (const { slug, reason, endpoint } of mintFailures) {
          ...
          switch (reason) {
            ...
            case 'mint_url_rejected':
              // Name the endpoint when the backend could surface it safely, so
              // the user knows what to add to oauth_endpoints.json; fall back to
              // the unnamed message when it could not be named (host-borne
              // credential, userinfo, or unparseable URL).
              error = endpoint
