...
export const MODEL_UNENTITLED_KIND = 'model_unentitled'
...
export const ErrorCard = memo(function ErrorCard({
  ...
  const elsewhere = unentitledElsewhere && !(onPickModel && onOpenDefaultModel)
      ...
      >
        ...
        {elsewhere && (
          <div className="text-[12px] leading-5 text-muted" data-testid="error-card-elsewhere-hint">
            {i18nT('pages.chat.errorCard.elsewhere_hint')}
          </div>
        )}
