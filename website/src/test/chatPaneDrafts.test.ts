...
import { readPaneDraft, writePaneDraft, takePaneDraft, mergePaneDraft, subscribePaneDraft, PANE_DRAFTS_KEY } from '../utils/chatPaneDrafts'
...
describe('chatPaneDrafts', () => {
  beforeEach(() => {
    ...
    for (const k of ['a', 'b', 'quota']) writePaneDraft(k, { text: '', files: [] })
  })
